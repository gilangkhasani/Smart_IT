...
<html lang="en">
	...
	<body>	
		<div class="box box-info">
			<div class="col-lg-16">
				<div class="box-body">
				<h3 align="center">Detail Barang Import</h3>
				<table id="table-1" class="table-bordered" style="font-size:small;">
					...
					<tbody>
						...
						<tr>
							...
							<input type="hidden" name="barang_code[]" id="barang_code" value="<?php echo $import_dt->barang_code?>"/>
							</td>
							<td><?php echo $import_dt->barang_name?>
							<input type="hidden" name="barang_name[]" id="barang_name" value="<?php echo $import_dt->barang_name?>"/>
							</td>
							<td style="display:none;"><?php echo $import_dt->satuan_code?>
							<input type="hidden" name="satuan_code[]" id="satuan_code" value="<?php echo $import_dt->satuan_code?>"/>
							</td>
							<td><?php echo $import_dt->satuan_doc?>
							<input type="hidden" name="satuan_doc[]" id="satuan_doc" value="<?php echo $import_dt->satuan_doc?>"/>
							</td>
							<td><?php echo $import_dt->jumlah_doc?>
							<input type="hidden" name="jumlah_doc[]" id="jumlah_doc" value="<?php echo $import_dt->jumlah_doc?>"/>
							</td>
							<td style="display:none;"><?php echo $import_dt->nilai_konversi?>
							<input type="hidden" name="nilai_konversi[]" id="nilai_konversi" value="<?php echo $import_dt->nilai_konversi?>"/>
							</td>
							<td><?php echo $import_dt->nilai_barang?>
							<input type="hidden" name="nilai_barang[]" id="nilai_barang" value="<?php echo $import_dt->nilai_barang?>"/>
							</td>
						</tr>
						<?php } ?>
					</tbody>
