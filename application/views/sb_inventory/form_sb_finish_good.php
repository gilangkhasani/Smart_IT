...
<html lang="en">
	...
	<body>	
		...
		<form method="post" action="<?php echo base_url()?>index.php/Sb_inventory/save" class="form-horizontal" name="form1" id="form1">
			<div class="row">
			<div class="col-lg-12">
						...
						<div class="box-body">
							<table>
								...
								<tr>
									...
									<td> &nbsp : &nbsp <input type="text" name="no_penerimaan" id="no_penerimaan" style="width:175px;" value="" placeholder="Nomor"/></td>
								...
								<tr>
									...
									<td> &nbsp : &nbsp <input type="text" name="jumlah" id="jumlah" style="width:175px;" value="" placeholder="Finish Good"/></td>
									<td>&nbsp/&nbsp <input type="text" name="jumlah2" id="jumlah2" style="width:175px;" value="" placeholder="Reject"/></td>
								</tr>
								<tr>
									<td></td>
									<td> &nbsp &nbsp &nbsp 
			...
			<div>
				<table id="table-1" class="table table-hover" border="1px solid black"  frame="box" >
					...
					<tr>
						...
						<td>Kode Barang</td>
						<td>Jumlah Barang Jadi</td>
						<td>Jumlah Barang Reject</td>
					</tr>
					</thead>
					<?php if ($prod_id != "") { ?>
					<tbody>
						...
						<tr>
							...
							<td><?php echo $prod_request_dt->Reject?></td>
						<?php } ?>
						</tr>
					</tbody>
					<?php } else {?>
			...
			<a href="<?php echo base_url()?>index.php/Sb_inventory/listing">Back to Menu</a>
