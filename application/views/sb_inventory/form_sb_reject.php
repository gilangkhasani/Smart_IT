...
<html lang="en">
			...
			$(document).ready(function(){
				...
				$('#b-edit').click( function () {	
					if(confirm("Apakah anda akan mengedit ?") == true){
						$("#request_id").val($('#table-1 tbody .selected').find('td:eq(0)').text());
	...
	<body>	
		...
		<form method="post" action="<?php echo base_url()?>index.php/Sb_inventory/save_reject" class="form-horizontal" name="form1" id="form1">
			<div class="row">
			<div class="col-lg-6">
						...
						<div class="box-body">
							<table>
								<tr>
									...
									<td> &nbsp : &nbsp <input type="text" name="prod_id" id="prod_id" value="<?php echo $prod_id?>" 
									<?php if ($prod_id != ""){?>
									readonly style="background:#eae9e9;"
									<?php } ?>/></td>
									<td><input type="text" name="barang_codes" id="barang_codes" value="<?php echo $kd_brg?>"
									<?php if ($prod_id != ""){?>
									readonly style="background:#eae9e9;"
									<?php } ?> />
									</td>
								...
								<tr>
									<td><label>Kode/Tgl Penerimaan</label></td>
									<td> &nbsp : &nbsp <input type="text" name="no_penerimaan" id="no_penerimaan" value=""/></td>
									<td><input type="text" name="tgl_penerimaan" id="tgl_penerimaan" value=""/></td>
								</tr>
								<tr>
									<td><label>Jumlah</label></td>
									<td> &nbsp : &nbsp <input type="text" name="jumlah" id="jumlah" value=""/></td>
								</tr>
								<tr>
									<td></td>
									<td> &nbsp &nbsp &nbsp 
