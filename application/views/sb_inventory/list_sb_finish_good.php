	...
	<div class="col-lg-16">
		<div class="box box-info">
			<div class="box-header">
				<div class="box-title">		
					<h3>List of Finish Good <?php echo $this->uri->segment(3)?></h3>
				</div>
				...
				<table class="table table-hover" id="table-1" style="border-bottom:1px solid;border-top:1px solid;">
					...
					<tbody>
						...
						<tr>
							...
							<td><a class="btn btn-success btn-small" style="height:27px; font-size:11px;" href="<?php echo base_url()?>index.php/Sb_inventory/change_finish_good/<?php echo $inventory->prod_id?>">Finish Good</a></td>
							<?php $tes++;
							} ?>
						</tr>
						<?php if ($tes==0){?>
