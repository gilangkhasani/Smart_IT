	...
	<div class="col-lg-16">
		<div class="box box-info">
			<div class="box-header">
				<div class="box-title">	
					<h3>List Work In Process <?php echo $this->uri->segment(3)?></h3>
				</div>
				...
				<div id="message-loading"></div>
					...
					<tbody>
						...
						<tr>
							...
							<td><a class="btn btn-success btn-small" style="height:27px; font-size:11px;" href="<?php echo base_url()?>index.php/Sb_inventory/change_wip/<?php echo $inventory->prod_id?>">WIP</a></td>
							<?php $tes++; } 
							?>
						</tr>
						<?php if ($tes==0){?>
								<tr>
									<td colspan="5"><center>No Rows</center></td>
								</tr>
							<?php } ?>
					</tbody>
				</table>
