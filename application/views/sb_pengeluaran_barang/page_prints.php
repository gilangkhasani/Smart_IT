...
<script type="text/javascript">
	...
	<h4>LAPORAN PENGELUARAN BARANG PER DOKUMEN PABEAN</h4>
	...
	<table class="bordered" style="font-size:11px; width:100%;">
		<thead>	
			<tr>
				...
				<td><center>No. Pengeluaran</center></td>
				<td><center>Tgl. Pengeluaran</center></td>
		...
		<?php $i=1; ?>
		<?php foreach($export as $data_export){ ?>
		<tr>
			<td><center><?php echo $i;?></center></td>
			<td><?php echo $data_export->jenis_doc?></td>
			<td><?php echo $data_export->no_doc?></td>
			<td><?php echo $data_export->tgl_doc?></td>
			<td><?php echo $data_export->no_bukti?></td>
			<td><?php echo $data_export->tgl_bukti?></td>
			<td><?php echo $data_export->supplier_name?></td>
			<td><?php echo $data_export->barang_code?></td>
			<td><?php echo $data_export->barang_name?></td>
			<td><?php echo $data_export->satuan_doc?></td>
			<td align="right"><?php echo number_format($data_export->jumlah_doc,2)?></td>
			<td><?php echo $data_export->valas?></td>
			<td align="right"><?php echo number_format($data_export->nilai_barang,2)?></td>
		</tr>
		<?php $i++; ?>
		<?php } ?>
	</table>
