...
<html>
    <head>
        ...
        <!-- Theme style -->
        <link href="<?php echo base_url()?>template_lala/css/datepicker3.css" rel="stylesheet" type="text/css" />
  ...
  <script>
	...
	<div id="load"></div>
        ...
        <div class="row-offcanvas-left">
            ...
            <aside class="right-side" style=" position:relative;margin-top:50px;">
      ...
      <div class="modal-dialog" style="width: 500px;">
		...
		<!-- jQuery UI 1.10.3 -->
        <script src="<?php echo base_url()?>template_lala/js/jquery-ui-1.10.3.min.js" type="text/javascript"></script>
        <!-- Bootstrap -->
        ...
        <!-- datepicker -->
        <script src="<?php echo base_url()?>template_lala/js/bootstrap-datepicker.js" type="text/javascript"></script>
